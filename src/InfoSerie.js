        ...
        <div className='container'>
          ...
          <form>
            ...
            <div className='form-group'>
              ...
              <input type='text' value={form.comments} onChange={onchange('comments')} className='form-control' placeholder='Nome da série' />
            </div>
